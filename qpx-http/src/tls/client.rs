use super::builder;
pub use super::builder::BoxTlsStream;
use anyhow::Result;
...
pub async fn connect_tls_http1(domain: &str, stream: TcpStream) -> Result<BoxTlsStream> {
    connect_tls_http1_with_options(domain, stream, true, None).await
}

pub async fn connect_tls_http1_with_options(
    domain: &str,
    stream: TcpStream,
    verify: bool,
...
pub async fn connect_tls_h2_h1_with_options(
    domain: &str,
    stream: TcpStream,
    verify: bool,
    trust: Option<&CompiledUpstreamTlsTrust>,
...
pub async fn connect_tls_h2_h1_with_info_with_options(
    domain: &str,
    stream: TcpStream,
    verify: bool,
    trust: Option<&CompiledUpstreamTlsTrust>,
...
pub async fn preview_tls_certificate_with_options(
    domain: &str,
    stream: BoxTlsStream,
    verify: bool,
    trust: Option<&CompiledUpstreamTlsTrust>,
