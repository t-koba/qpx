...
require .github/workflows/ci.yml 'QPX_PERF_SMOKE_JSON: target/perf/perf-smoke.jsonl'
require .github/workflows/ci.yml 'QPX_PERF_SMOKE_JSON: target/perf/advanced-transport-perf.jsonl'
