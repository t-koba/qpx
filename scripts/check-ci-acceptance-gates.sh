...
require Cargo.toml 'rust-version = "1.87"'
...
require qpxd/src/forward/request/dispatch/access.rs 'apply_ext_authz_http_access'
require qpxd/src/reverse/transport/dispatch/access.rs 'apply_ext_authz_http_access'
require qpxd/src/transparent/http/dispatch/access.rs 'apply_ext_authz_http_access'
...
require qpxd/src/reverse/h3/passthrough/index/shared.rs 'crate::sharding::modulo_u64'
require qpxd/src/transparent/udp/session/index.rs 'crate::sharding::modulo_u64'
require qpxd/src/http/modules/response_compression/streaming.rs 'crate::sharding::modulo_u64'
...
require qpxd/src/tls/mod.rs 'pub(crate) mod trust'
require qpxd/src/tls/mod.rs 'qpx_http::tls::{builder, client}'
...
require deny.toml 'wildcards = "deny"'
...
require .github/workflows/ci.yml 'dtolnay/rust-toolchain@1.87'
