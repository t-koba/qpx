...
require .github/workflows/ci.yml 'cargo test -p qpxd --release --test advanced_transport_perf --locked --features http3-backend-qpx,mitm -- --nocapture'
require .github/workflows/ci.yml 'actions/upload-artifact@v4'
require .github/workflows/ci.yml 'qpx-perf-smoke-jsonl'
require .github/workflows/ci.yml "github.event_name == 'workflow_dispatch' || github.event_name == 'release' || startsWith(github.ref, 'refs/tags/')"
...
require .github/workflows/ci.yml 'cargo test -p qpxd --release --test perf_smoke --locked --features http3-backend-h3 -- --nocapture'
require .github/workflows/ci.yml 'cargo test -p qpxd --release --test perf_smoke --locked --features http3-backend-qpx -- --nocapture'
...
require scripts/perf-audit-proxy-compare.sh 'service_name="qpx_proxy_compare_$$"'
...
require scripts/perf-audit-proxy-compare.sh 'wrk -t"$THREADS" -c"$CONCURRENCY"'
...
require scripts/h3-interop/run.sh 'quiche-client'
require scripts/h3-interop/run.sh 'nghttp3-client'
