...
require scripts/perf-audit-proxy-compare.sh 'rss_growth_kb'
require scripts/perf-audit-proxy-compare.sh 'fd_peak'
require scripts/perf-audit-proxy-compare.sh 'fd_growth'
require scripts/perf-audit-proxy-compare.sh '.resource_measurement = "sampled_workload_peak_v1"'
...
require scripts/perf-audit-http2-compare.sh '"benchmark_schema_version": 7'
require scripts/perf-audit-http2-compare.sh 'rss_baseline_kb'
require scripts/perf-audit-http2-compare.sh 'rss_peak_kb'
require scripts/perf-audit-http2-compare.sh 'rss_growth_kb'
require scripts/perf-audit-http2-compare.sh 'total_rss_peak_kb'
require scripts/perf-audit-http2-compare.sh 'fd_baseline'
require scripts/perf-audit-http2-compare.sh 'total_fd_peak'
require scripts/perf-audit-http2-compare.sh 'fd_growth'
require scripts/perf-audit-http2-compare.sh '"resource_measurement": "sampled_workload_peak_v1"'
require scripts/perf-audit-http2-compare.sh 'scheduler_queue_delay_us_per_request'
require scripts/check-http2-performance.sh 'growth != peak - baseline'
require scripts/check-http2-performance.sh 'inconsistent total_rss_growth_kb'
require scripts/check-http2-performance.sh 'inconsistent total_fd_growth'
...
require perf/http2-performance-objectives.json '"resource_measurement": "sampled_workload_peak_v1"'
...
require scripts/perf-audit-streaming-compare.sh '"benchmark_schema_version": 5'
...
require scripts/perf-audit-streaming-compare.sh 'total_rss_growth_kb'
require scripts/perf-audit-streaming-compare.sh 'total_fd_peak'
require scripts/perf-audit-streaming-compare.sh 'total_fd_growth'
require scripts/perf-audit-streaming-compare.sh '"resource_measurement": "sampled_workload_peak_v1"'
require scripts/perf-audit-streaming-compare.sh 'scheduler_queue_delay_us_per_transfer'
require scripts/check-streaming-performance.sh 'growth != peak - baseline'
require scripts/check-streaming-performance.sh 'inconsistent total_rss_growth_kb'
require scripts/check-streaming-performance.sh 'inconsistent total_fd_growth'
...
require scripts/compare-proxy-baseline.sh 'proxy baseline schema 4 uses an unsupported resource measurement'
require scripts/compare-proxy-baseline.sh 'proxy baseline schema 3 must not claim a resource measurement'
require scripts/compare-proxy-baseline.sh 'rss_growth_kb != rss_peak_kb - rss_baseline_kb'
require scripts/compare-proxy-baseline.sh 'fd_growth != fd_peak - fd_baseline'
...
require perf/proxy-performance-objectives.json '"resource_measurement": "sampled_workload_peak_v1"'
require scripts/perf-audit-proxy-compare.sh 'expect_qpx_backend_route_evidence'
require scripts/perf-audit-proxy-compare.sh 'X-Qpx-Perf-Upstream-Via'
