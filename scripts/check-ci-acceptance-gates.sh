...
require scripts/nightly-proxy-compare.sh 'require_cmd apache2'
...
require scripts/compare-proxy-baseline.sh 'qpxd_requests_per_sec / direct-backend_requests_per_sec'
