...
require .github/workflows/ci.yml 'sudo apt-get install -y apache2 apache2-utils lighttpd nginx'
...
require scripts/nightly-proxy-compare.sh 'ab -k -n "$REQUESTS" -c "$CONCURRENCY"'
