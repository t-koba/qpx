...
require .github/workflows/ci.yml 'target/perf/nightly-criterion.jsonl'
require .github/workflows/ci.yml 'cargo bench -p qpxd --bench streaming_throughput --locked -- --sample-size 10'
require .github/workflows/ci.yml 'sudo apt-get install -y apache2 apache2-utils lighttpd nginx wrk'
require .github/workflows/ci.yml 'cargo build -p qpxd --release --locked'
require .github/workflows/ci.yml 'QPX_PROXY_COMPARE_JSON: ${{ github.workspace }}/target/perf/nightly-proxy-compare.jsonl'
require .github/workflows/ci.yml 'scripts/nightly-proxy-compare.sh "$QPX_PROXY_COMPARE_JSON"'
require .github/workflows/ci.yml 'scripts/compare-proxy-baseline.sh target/perf/nightly-proxy-compare.jsonl perf/baseline-proxy-compare.json'
require scripts/nightly-proxy-compare.sh '"proxy_compare_http1_reverse"'
require scripts/nightly-proxy-compare.sh 'require_cmd nginx'
require scripts/nightly-proxy-compare.sh 'APACHE_BIN="${QPX_PROXY_COMPARE_APACHE_BIN:-}"'
require scripts/nightly-proxy-compare.sh 'command -v apache2'
require scripts/nightly-proxy-compare.sh 'command -v httpd'
require scripts/nightly-proxy-compare.sh 'missing required command: apache2 or httpd'
require scripts/nightly-proxy-compare.sh 'require_cmd lighttpd'
require scripts/nightly-proxy-compare.sh 'require_cmd wrk'
require scripts/nightly-proxy-compare.sh 'wrk -t"$THREADS" -c"$CONCURRENCY"'
require scripts/nightly-proxy-compare.sh 'non_2xx_responses'
require scripts/nightly-proxy-compare.sh 'bad_length_responses'
require scripts/nightly-proxy-compare.sh 'failed_requests'
require scripts/nightly-proxy-compare.sh 'status_before'
require scripts/nightly-proxy-compare.sh 'proxy-compare-logs'
...
require .github/workflows/ci.yml 'qpx-nightly-perf-jsonl'
