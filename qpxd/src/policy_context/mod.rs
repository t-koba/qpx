...
pub(crate) mod audit_facade {
    pub(crate) use super::{AuditRecord, attach_log_context, emit_audit_log};
}

pub(crate) mod ext_authz_facade {
    pub(crate) use super::{
