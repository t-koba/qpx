...
pub(crate) fn parse_authority_host_port(input: &str, default_port: u16) -> Option<(String, u16)> {
    parse_authority_host_port_with_default(input, Some(default_port))
}

pub(crate) fn parse_authority_host_port_with_default(
    input: &str,
...
pub(crate) fn format_authority_host_port(host: &str, port: u16) -> String {
...
#[cfg(test)]
mod tests {
    use crate::http::protocol::address::*;
