...
impl Sender {
    ...
    pub fn is_closed(&self) -> bool {
        self.close_signal.flag.load(Ordering::Acquire)
    }
    ...
    pub async fn closed(&self) {
        ...
        self.close_signal.notify.notified().await;
    }
}

#[cfg(test)]
pub(crate) async fn to_bytes<B>(body: B) -> Result<Bytes, BodyError>
where
...
pub(crate) async fn to_bytes_limited<B>(mut body: B, max_bytes: usize) -> Result<Bytes, BodyError>
where
