...
pub fn parse_vary(headers: &http::HeaderMap) -> VarySpec {
...
pub fn vary_values_from_request_headers(
...
pub fn request_header_values(headers: &http::HeaderMap, name: &str) -> String {
...
pub fn index_storage_key(primary: &str) -> String {
    format!("idx:{}", primary)
}
